...
import { useCreateLoop } from "@/lib/axios/loops";
...
const CreateLoopPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Use the mutation to create the loop
            const result = await createLoopMutation.mutateAsync({
            ...
            if (result.success) {
                ...
                router.push(`/loops/${result.loop?.id}`);
            } else {
